...
class TestUserViewSet:
    def test_list_users_enveloped(self, admin_client: APIClient) -> None:
        ...
        assert payload["pagination"]["count"] == 4
        assert len(payload["data"]) == 4

    def test_list_users_anonymous_gets_enveloped_error(self, api_client: APIClient) -> None:
    ...
    def test_retrieve_user(self, authenticated_client: APIClient, user) -> None:
    ...
    def test_create_user_hashes_password(self, authenticated_client: APIClient) -> None:
        payload = {
            "username": "newuser",
            "email": "new@example.com",
            "password": "testpass123",
        }
        response = authenticated_client.post("/api/users/", payload)
    ...
    def test_delete_user_returns_200_envelope(self, authenticated_client: APIClient, user) -> None:
